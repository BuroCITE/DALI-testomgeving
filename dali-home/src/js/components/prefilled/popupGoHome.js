...
export function PopupGoHome(props){
  ...
  return(
    <Popup showModalButtonClass="header-buttons" showModalButtonContents={icons.iElement.home} modalFeatures={`${props.pageAccent}-sm`} modalHeaderTitle="Toepassing sluiten">
